...
async function processToken() {
  ...
  try {
    // Use Clerk's signIn with the ticket strategy
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any -- Clerk Nuxt SDK types don't expose create() on SignInResource
    const si = signIn.value as any;
