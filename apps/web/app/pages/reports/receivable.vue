...
const narrative = ref(
  "$285 pendientes de cobro. $65 tienen más de 30 días (rojo). Sugerencia: enviar recordatorio a Juan Pérez y Pedro López.",
);
const debtors = ref([
  {
    name: "Pedro López",
  ...
  <SharedReportLayout title="Cuentas por cobrar" :narrative="narrative">
    <div class="mb-4 grid grid-cols-3 gap-3">
      <div class="rounded-xl bg-green-50 p-4 text-center">
        ...
        <p class="text-xs text-green-600">&lt;15 días</p>
      </div>
      <div class="rounded-xl bg-yellow-50 p-4 text-center">
        <p class="text-xl font-bold text-yellow-700">$70</p>
        <p class="text-xs text-yellow-600">15-30 días</p>
      </div>
      <div class="rounded-xl bg-red-50 p-4 text-center">
        <p class="text-xl font-bold text-red-700">$165</p>
        <p class="text-xs text-red-600">&gt;30 días</p>
      </div>
    </div>
    <div class="rounded-xl bg-white shadow-sm overflow-hidden">
      <table class="w-full text-left text-sm">
        <thead class="border-b bg-gray-50">
          <tr>
            <th class="px-5 py-3 font-medium text-gray-500">Cliente</th>
            <th class="px-5 py-3 text-right font-medium text-gray-500">
              Monto
            </th>
            <th class="px-5 py-3 text-right font-medium text-gray-500">Días</th>
          </tr>
        </thead>
