...
const narrative = ref(
  "150 productos activos con valor total de $4,500. 3 productos en stock crítico y 5 sin movimiento en 60+ días.",
);
</script>

<template>
  <SharedReportLayout title="Movimiento de inventario" :narrative="narrative">
    ...
    <div class="rounded-xl bg-white p-5 shadow-sm">
      ...
      <div class="grid grid-cols-3 gap-4 text-center">
        ...
        <div>
          <p class="text-xl font-bold text-red-600">320</p>
          <p class="text-xs text-gray-500">Salidas (ventas)</p>
        </div>
        <div>
