...
# Nitro externalizes @clerk/shared runtime files. The web uses @clerk/shared@4.x
# (nested inside @clerk/nuxt/node_modules) but the top-level node_modules has 3.x.
# Copy the correct version from the nested location.
